namespace MediatorLib.Mapping
{
    ...
    public sealed partial class MapperConfiguration
    {
        ...
        /// <summary>
        /// Gets a collection of all distinct source types that have registered mappings.
        /// </summary>
        public IDictionary<Type, Type> SourceTypes => _maps.Keys.ToDictionary(k => k.Source, k => k.Destination);
